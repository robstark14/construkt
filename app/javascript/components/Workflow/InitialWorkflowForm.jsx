...
const [values, setValues] = useState({
  ...
  const fetchUsers= async () =>{
    ...
    form.append("current_activity_owner", values?.currentActivityOwner)
    form.append("next_activity_owner", values?.nextActivityOwner)
 ...
 <form className="w-full grid grid-cols-3 h-full gap-5 place-content-center">
  <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
    ...
    <div className="my-4">
      ...
      <input readOnly value={publishedBy} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Username"/>
    </div>
  ...
  <button className="bg-sky-600 hover:bg-blue-700 text-white font-bold py-2 px-4 border-b-4 border-sky-700 hover:border-sky-500 rounded-xl m-4">
